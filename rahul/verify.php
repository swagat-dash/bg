...
require 'config.php';
$ap3="INSERT INTO transactions(r_name,product,commission,t_date,t_status,t_id,email,product_id,promo_code,r_id,p_type) VALUES('$fullname','$_SESSION[ptype]','$_SESSION[commission]','$date','pending','$t_id','$_SESSION[email]','$_SESSION[pid]','$_SESSION[promo_code]','$_SESSION[refrallcode]','$pay_method')";
mysqli_query($ap,$ap3);
mysqli_close($ap);
