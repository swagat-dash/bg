...
if(isset($ap3["utype"]))
{
  echo '<tr><td>'.$ap3["utype"].'</td><td>'.$ap3["r_id"].'</td><td>'.$ap3["ptype"].'</td><td>'.$ap["t_id"].'</td><td>'.$ap3["r_name"].'</td><td>'$ap3["product"].$ap3["product_id"].'</td><td>'.$ap3["commission"].'</td><td>'.$ap3["t_date"].'</td>';
